...
final class AutorController extends AbstractController
{
    ...
    public function show(#[MapEntity(mapping: ['CodAu' => 'CodAu'])] Autor $autor): Response
    {
    ...
    public function edit(#[MapEntity(mapping: ['CodAu' => 'CodAu'])] Autor $autor, Request $request, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(AutorType::class, $autor);
        $form->handleRequest($request);
