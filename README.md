...
O projeto é um sistema simples para ler/cadastrar/editar/excluir (CRUD) de Livros, Autores, Assuntos/Generos utilizando a linguagem de programação PHP com o Framework Symfony 7 e o Twig Template Engine.
